...
?>
	...
	<style>
		...
		.sidebar-container .header h3,#webbooker-main .header h3,#webbooker-activity-book #activity-availability.avail strong,#webbooker-activity-book #activity-availability.avail span,.activity.box-rounded h3 a,#webbooker-search-results .activity .price .amount span, .bigPrice h2, .bigPrice p{color:<?php echo $textcustomColor;?>}a.buttonBlue,button.buttonBlue{background:<?php echo $wb['customColor'];?>;color:<?php echo $textcustomColor;?>}a.buttonBlue:hover,button.buttonBlue:hover{background:<?php echo $lightcustomColor;?>;border-color:<?php echo $wb['customColor'];?>;color:<?php echo $textcustomColor;?>}.buttonBlue[disabled]{background:<?php echo $lightcustomColor;?>}.sidebar-container .header,#webbooker-main .header, .activity.box-rounded h3,#webbooker-search-results .activity .price .amount, .bigPrice{background:<?php echo $wb['customColor'];?>;border-color:<?php echo $darkcustomColor;?>;color:<?php echo $textcustomColor;?>}.ui-state-highlight,.ui-widget-content .ui-state-highlight{color:<?php echo $textcustomColor;?>}.ui-state-active,.ui-widget-content .ui-state-active{background:<?php echo $lightcustomColor;?>!important;border-color:<?php echo $darkcustomColor;?>}.point{border-top-color:<?php echo $wb['customColor'];?>;-webkit-filter: drop-shadow(0 1px 0 <?php echo $darkcustomColor;?>) drop-shadow(0 3px 5px rgba(0,0,0,.3));-moz-filter: drop-shadow(0 1px 0 <?php echo $darkcustomColor;?>) drop-shadow(0 3px 5px rgba(0,0,0,.3));filter: drop-shadow(0 1px 0 <?php echo $darkcustomColor;?>) drop-shadow(0 3px 5px rgba(0,0,0,.3));}@media all and (max-width:980px){#webbooker-search-results .activity .price .amount{background:0;color:#888;border:0}#webbooker-search-results .activity .price .amount span{color:#888}}
	</style>
